  ...
  return (
    <div className={className}>
      <svg fill="none" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" x="0" y="0">
        <defs>
          <mask height="32" id="mask23_451_3" style={{ maskType: "alpha" }} width="32" xmlns="http://www.w3.org/2000/svg" x="0" y="0" maskUnits="userSpaceOnUse">
            <rect height="32" id="Bounding box_24" width="32" fill="#D9D9D9" x="0" y="0" />
          </mask>
        </defs>
        <g id="kid_star_43" xmlns="http://www.w3.org/2000/svg">
          <mask height="32" id="mask23_451_3" style={{ maskType: "alpha" }} width="32" x="440" y="1628" maskUnits="userSpaceOnUse">
            <rect height="32" id="Bounding box_24" width="32" fill="#D9D9D9" x="440" y="1628" />
          </mask>
          <g mask="url(#mask23_451_3)">
            <path
              id="kid_star_44"
